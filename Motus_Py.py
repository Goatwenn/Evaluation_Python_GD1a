...
#print(resultat_1,resultat_2,resultat_3,resultat_4)
    ...
    choix_position = int(input(" Quelle lettre voulez vous changer?(1 à 24)  :"))-1
    nouvelle_lettre = str(input(" Par quelle lettre?  :"))
    ...
    # ----- Condition de Victoir  
    resultat_totatle = int(resultat_1+resultat_2+resultat_3+resultat_4)
    if (resultat_totatle == 24):
        conditon_victoir = 1

print(" Vous avez trouver tout les mots!")
